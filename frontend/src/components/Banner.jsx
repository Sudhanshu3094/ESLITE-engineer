...
const Banner = () => {
  ...
  return (
    <div className='flex bg-neutral-200 rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
      {/* {----------left side----------} */}
      <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5'>
         <div className='text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold text-zinc-600'>
            <p>Book Meeting</p>
            <p className='mt-4'>With 100+ Trusted Engineers</p>
         </div >
